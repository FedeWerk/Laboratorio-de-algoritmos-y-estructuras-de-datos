...
# Crea dos variables (num1 y  num2) con los valores 36 y 17 respectivamente. Verifica si num1 es mayor o igual
# que num2 y almacena el resultado de dicha comparación en una variable llamada mi_bool
...
# Verifica si num1 es mayor que num2, y menor que num3. Almacena el resultado de dicha comparación
...
# Verifica si num1 es mayor que num2, o menor que num3. Almacena el resultado de dicha comparación
# en una variable llamada mi_bool.
...
# Las leyes de un país establecen que un adulto puede conducir si tiene licencia para hacerlo, y para optar por una licencia para conducir,
...
# if edad<18 and tiene_licencia.lower()== "no":
#     print("No puedes conducir aún. Debes tener 18 años y contar con una licencia")
# elif edad>=18 and tiene_licencia.lower()== "si":
#     print("Puedes conducir")
# elif edad>=18 and tiene_licencia.lower()== "no":
...
habla_ingles = input("¿Sabes inglés? ")
sabe_python = input("¿Sabes Python? ")

if habla_ingles.lower() == "si" and sabe_python.lower() == "si": 
    print("Cumples con los requisitos para postularte")

if habla_ingles.lower() == "no" and sabe_python.lower() == "no": 
    print("Para postularte, necesitas saber programar en Python y tener conocimientos de inglés")

if habla_ingles.lower() == "no" and sabe_python.lower() == "si": 
    print("Para postularte, necesitas tener conocimientos de inglés")

if habla_ingles.lower() == "si" and sabe_python.lower() == "no": 
