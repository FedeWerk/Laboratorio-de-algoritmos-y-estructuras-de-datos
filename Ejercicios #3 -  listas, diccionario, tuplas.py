...
mi_lista = ["Lab. Algortimos", "Mat. Discreta", "Herramientas matemáticas", "AENS II", "Des. Emprendedor"] 
print(mi_lista)
#-----------------------------------------------------------------------------------------------------
...
# Práctica Listas 3
# Utiliza el método pop() para quitar el tercer elemento de la siguiente lista llamada frutas, y almacénalo
...
mi_dic = {"nombre":"Karen", "apellido":"Jurgens", "edad":"35","ocupacion": "Periodista"}
mi_dic["pais"]="Colombia"; mi_dic["edad"]="36"; mi_dic["ocupacion"]="Editora"
print(mi_dic)
#-----------------------------------------------------------------------------------------------------
